...
*** Variables ***
${url}  htthttps://the-internet.herokuapp.com/
*** Test Cases ***
Implicit Wait
...
#Set Selenium Implicit Wait = this keyword lets you set imlicit wait, usually in seconds is recommended
#Set Browser Implicit Wait = this keyword lets you set implicit wait for one browser instance,
#    if there are multiple browsers then it will be confined to that browser